...
/**
 * risk-service uses a SINGLE broker: broker-a:9092.
 * Consumes loan.applied (from loan-service on broker-a) and produces risk.assessed + loan.rejected.
 */
@Configuration
public class KafkaConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "risk");
